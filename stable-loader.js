/* DeepRise Stable Loader v16.5.1 */
(()=>{'use strict';
...
(async()=>{
  try{
    const r=await fetch('./index.html?stable=16.5.1&t='+Date.now(),{cache:'no-store'});
    ...
    html=html.replace('deeprise-v13-gate-hotfix.js?v=1310','deeprise-v13-gate-hotfix.js?v=1651');
    html=html.replace('pwa.js?v=1310','pwa.js?v=1651');
    document.open();
    document.write(html);
    document.close();
