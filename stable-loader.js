/* DeepRise Stable Loader v17.0.0 */
(()=>{'use strict';
...
(async()=>{
  try{
    const r=await fetch('./index.html?stable=17.0.0&t='+Date.now(),{cache:'no-store'});
    ...
    if(startup.test(html))html=html.replace(startup,safe);
    html=html.replace('deeprise-fast-search-v160.js?v=1601','deeprise-fast-search-v160.js?v=1651');
    html=html.replace(/deeprise-v13-gate-hotfix\.js\?v=(?:1310|1651)/,'deeprise-v13-gate-hotfix.js?v=1700');
    html=html.replace('pwa.js?v=1310','pwa.js?v=1700');
    document.open();
    document.write(html);
    document.close();
