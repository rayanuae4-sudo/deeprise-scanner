/* DeepRise Stable Loader v16.3.1 */
(()=>{'use strict';
...
(async()=>{
  try{
    const r=await fetch('./index.html?stable=16.3.1&t='+Date.now(),{cache:'no-store'});
    ...
    html=html.replace('deeprise-fast-search-v160.js?v=1601','deeprise-fast-search-v160.js?v=1631');
    document.open();
    document.write(html);
    document.close();
