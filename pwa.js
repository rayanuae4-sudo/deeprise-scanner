...
if('serviceWorker' in navigator)addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=stable-v13-6',{updateViaCache:'none'}).then(r=>r.update()).catch(()=>{}));
...
function nextCandleLayer(){if(document.getElementById('dr-next-candle-loader'))return;let s=document.createElement('script');s.id='dr-next-candle-loader';s.src='./deeprise-next-candle-v14.js?v=1400';s.defer=true;document.body.appendChild(s)}
