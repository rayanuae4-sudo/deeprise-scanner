...
if('serviceWorker' in navigator) addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=stable-v12-1',{updateViaCache:'none'}).then(r=>r.update()).catch(()=>{}));
...
addEventListener('load',()=>setTimeout(button,1800));
})();