...
if('serviceWorker' in navigator)addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=stable-v14-2',{updateViaCache:'none'}).then(r=>r.update()).catch(()=>{}));
...
function tradeMonitorLayer(){if(document.getElementById('dr-trade-monitor-loader'))return;let s=document.createElement('script');s.id='dr-trade-monitor-loader';s.src='./deeprise-trade-monitor-v14.js?v=1420';s.defer=true;document.body.appendChild(s)}
