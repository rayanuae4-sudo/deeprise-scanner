...
if('serviceWorker' in navigator)addEventListener('load',()=>navigator.serviceWorker.register('./sw.js?v=recovery-v16-0-1',{updateViaCache:'none'}).then(r=>r.update()).catch(()=>{}));
