/* DeepRise V17 Performance + Reversal Intelligence
...
const T={
 ar:{
  title:'📊 Performance / سجل الأداء',sub:'خط أساس تاريخي مدقق من السجل المركزي؛ وتُتابع نتائج V17 كعينة مستقلة دون نسب مسبقة.',d7:'7 أيام',d30:'30 يومًا',all:'الكل',signals:'الإشارات',completed:'المكتملة',active:'النشطة',win:'Win Rate (TP2)',tp1:'TP1 Rate',tp2:'TP2 Rate',stop:'Stop Rate',avg:'متوسط زمن الهدف',long:'LONG',short:'SHORT',top3:'Top 3',v17:'عينة V17 ما قبل الحركة',ins:'بيانات غير كافية',excluded:'مستبعد من التدقيق',proof:'ACTIVE و TP1 HIT المفتوحة لا تدخل في الفوز/الخسارة. الحالات غير الحاسمة والواردات القديمة غير القابلة للتدقيق تستبعد. Win Rate = TP2 من الإشارات المكتملة.',close:'إغلاق',
 ...
 en:{
  title:'📊 Performance',sub:'Audited historical central-ledger baseline; V17 results are tracked as a separate cohort without a prefilled rate.',d7:'7 Days',d30:'30 Days',all:'All Time',signals:'Signals',completed:'Completed',active:'Active',win:'Win Rate (TP2)',tp1:'TP1 Rate',tp2:'TP2 Rate',stop:'Stop Rate',avg:'Avg. time to target',long:'LONG',short:'SHORT',top3:'Top 3',v17:'V17 pre-move cohort',ins:'Insufficient data',excluded:'Excluded from audit',proof:'Open ACTIVE/TP1 HIT signals do not count as wins or losses. Ambiguous results and unverifiable legacy imports are excluded. Win Rate equals TP2 hits among completed signals.',close:'Close',
 ...
 ru:{
  title:'📊 Performance / Результаты',sub:'Проверенная историческая база журнала; результаты V17 учитываются отдельной когортой без заранее заданной точности.',d7:'7 дней',d30:'30 дней',all:'Всё время',signals:'Сигналы',completed:'Завершено',active:'Активно',win:'Win Rate (TP2)',tp1:'TP1 Rate',tp2:'TP2 Rate',stop:'Stop Rate',avg:'Среднее время до цели',long:'LONG',short:'SHORT',top3:'Top 3',v17:'Когорта V17 до движения',ins:'Недостаточно данных',excluded:'Исключено из аудита',proof:'Открытые ACTIVE/TP1 HIT не считаются победой или поражением. Неоднозначные результаты и непроверяемые старые импорты исключаются. Win Rate = TP2 среди завершённых.',close:'Закрыть',
...
async function open(days=30){
 ...
 try{
  ...
  window.DeepRiseAnalytics?.capture?.('performance_dashboard_open',{days,records:rows.length,completed:s.c,app_version:'V17 PRO'});
